...
const ReadOnlyProductCard = ({ product, index, onRemove }: ReadOnlyProductCardProps) => {
  ...
  return (
    <View style={styles.card}>
      ...
      <View style={styles.infoRow}><Text style={styles.infoLabel}>Produto:</Text><Text style={styles.infoValue}>{product.nomeProduto}</Text></View>
      <View style={styles.row}>
        <View style={styles.halfInfo}><Text style={styles.infoLabel}>Quantidade:</Text><Text style={styles.infoValue}>{product.quantidade}</Text></View>
        <View style={styles.halfInfo}><Text style={styles.infoLabel}>Valor Unit.:</Text><Text style={styles.infoValue}>{fmt(product.valorUnitario)}</Text></View>
      </View>
      <View style={styles.infoRow}><Text style={styles.infoLabel}>Vendedor(es):</Text><Text style={styles.infoValue}>{product.vendedores.join(', ')}</Text></View>
