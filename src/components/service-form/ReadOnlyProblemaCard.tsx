...
const ReadOnlyProblemaCard = ({ problema, index, onRemove, onEdit }: ReadOnlyProblemaCardProps) => {
    ...
    <View style={styles.card}>
      ...
      {problema.solucao ? (
        ...
        <TouchableOpacity style={styles.addSolutionButton} onPress={() => onEdit(problema)}>
          <PenLine size={16} color={colors.textPrimary} />
...
const makeStyles = (colors: AppColors) =>
  StyleSheet.create({
    ...
    addSolutionText: { fontSize: 14, fontWeight: '600', color: colors.textPrimary },
  });
